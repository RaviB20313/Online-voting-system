                ...
                for($i=0 ;$i<count($groups);$i++){
                    ...
                    <img src ="../uploads/<?php echo $groups[$i]['photo']?>" alt="Image1">
                        ...
                        <div class ="col-md-8">
                            ...
                            <br>
                            <strong class="text-dark h5">Votes:</strong><br><?php echo $groups[$i]['votes']?>
                        </div>
                    </div>
                    <form action="../actions/voting.php" method="POST">
                        ...
                        <?php 
                            if($_SESSION['status']==1){
                                ?>
                                <button class="bg-success my-4  px-3 text-white">Voted</button>
                                <?php
                            }else{
                                ?>
                                <button class="bg-danger my-4 px-3 text-white" type="submit">Vote</button>
